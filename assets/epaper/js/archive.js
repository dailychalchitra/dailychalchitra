/* ================================================
   Daily Chalchitra ePaper Archive - v9.0 Rebuild
   CLEAN BUILD - Compatible with epaper.css v9.0
   ================================================ */
document.addEventListener("DOMContentLoaded", async () => {
    ...
    try {
        ...
        archiveList.innerHTML = `<div class="dc-empty">আর্কাইভ লোড করা যায়নি। issues.json ফাইলটি চেক করুন।</div>`;
        console.error(e);
        return;
    }
            ...
            ${filtered.map(issue => {
                ...
                <div class="dc-issue-card">
                    ...
                    <div class="dc-body">
                        ...
                        <h3 style="margin:0 0 6px 0;font-size:17px;">${issue.title || 'ই-পেপার'}</h3>
                        <div style="font-size:13px;color:#666;margin-bottom:12px;">${issue.count || 0} টি লেখা ${issue.pages? '| ' + issue.pages + ' পৃষ্ঠা' : ''}</div>
                        <a href="${issue.viewer || '#'}" style="background:#C00000;color:#fff;padding:8px 14px;border-radius:6px;text-decoration:none;font-size:13px;font-weight:600;display:inline-flex;align-items:center;gap:5px;">
